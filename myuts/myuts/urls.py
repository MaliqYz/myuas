...
from myuts.views import home, about, contact, detail_artikel
from myuts.authentikasi import akun_login, akun_registrasi, akun_logout

from berita.api import *

urlpatterns = [
    path("admin/", admin.site.urls),
    path("", home, name="home"),  # Perbaikan: Pola URL kosong
    path("about", about, name="about"),
    path("contact", contact, name="contact"),
    path("artikel/<slug:slug>",detail_artikel, name="detail_artikel"),
    path("dashboard/", include("berita.urls")),  # Perbaikan: Pola URL kosong
