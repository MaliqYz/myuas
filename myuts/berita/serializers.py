...
class BiodataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Biodata
        fields = ['user', 'alamat', 'telpon',] #disini saya tidak memasukan foto karena akan eror,sebelumnya saya membuat akun tidak ada memasukan foto, Maaf pak
...
class ArtikelSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Artikel
        fields = [
            'id','judul','isi','kategori','kategori_detail','author','author_detail',
