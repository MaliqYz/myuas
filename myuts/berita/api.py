...
def api_artikel_list(request):
    key_token = "d9bd1a051d850e11b7f935fc6dd4710a0a5a44a5857843e1f32ca7acd692c8f1"

    token = request.headers.get('token')
    if token == None:
        return Response({'message:harap masukkan token'}, status=status.HTTP_401_UNAUTHORIZED)
